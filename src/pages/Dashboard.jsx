...
// Helper: moving average (windowSize dni)
...
// Helper: bar chart - treningi/obroki po dnevih v tednu
...
// Helper: doughnut - razmerje športov
...
function Dashboard() {
  ...
  const totalCaloriesTr = trainings.reduce((sum, t) => sum + Number(t.calories), 0);
  const totalCaloriesMeals = meals.reduce((sum, m) => sum + Number(m.calories), 0);
  ...
  return (
    <div className="p-6 w-full min-h-screen bg-[#202533]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-[#232940]/80 rounded-xl p-5 shadow border-2 border-sky-300 flex flex-col items-center">
        ...
        <div className="bg-[#232940]/80 rounded-xl p-5 shadow border-2 border-pink-300 flex flex-col items-center">
      ...
      <div className="bg-[#232940]/80 rounded-xl p-5 shadow border-2 border-lime-300 mb-8 max-w-2xl mx-auto overflow-x-auto">
        <h2 className="text-lg text-lime-300 font-bold mb-3">
      ...
      {/* SPODNJA GRAFA (večja, izenačena) */}
      <div className="flex flex-col md:flex-row gap-10 justify-center items-start mb-12 max-w-5xl mx-auto">
        {/* Bar chart */}
        <div className="bg-[#232940]/80 rounded-xl p-5 shadow border-2 border-sky-300 w-full md:w-[420px] min-h-[260px]">
          <h2 className="text-base text-sky-300 font-bold mb-2">Treningi in obroki po dnevih v tednu</h2>
          <Bar
            data={{
        ...
        {/* Doughnut chart */}
        <div className="bg-[#232940]/80 rounded-xl p-5 shadow border-2 border-sky-300 w-full md:w-[420px] min-h-[260px] flex flex-col items-center">
          <h2 className="text-base text-sky-300 font-bold mb-2">Razmerje športov</h2>
          <Doughnut
            data={{
